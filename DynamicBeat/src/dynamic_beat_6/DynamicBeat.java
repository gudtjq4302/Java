...
public class DynamicBeat extends JFrame {
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/On_On Title Image.png"))
			.getImage();
	private Image selectedImage = new ImageIcon(Main.class.getResource("../images/On_On Start Image.png"))
			.getImage();
