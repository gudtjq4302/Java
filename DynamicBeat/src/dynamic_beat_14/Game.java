...
public class Game extends Thread{
	...
	public void dropNotes() {
		Beat[] beats =null;
		if(titleName.equals("Cartoon - On _ On (feat. Daniel Levi) _NCS Release_")){
		...
		else if(titleName.equals("Culture Code - Make Me Move")) {
		...
		else if(titleName.equals("Warriyo - Mortals")) {
			int startTime = 1000 - Main.REACH_TIME*1000;
			beats = new Beat[] {
					new Beat(startTime, "Space"),
			};
