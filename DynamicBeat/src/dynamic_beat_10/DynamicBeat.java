...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("","Cartoon - On _ On (feat. Daniel Levi) _NCS Release_.jpg","gameImage.png","Cartoon - On _ On (feat. Daniel Levi) _NCS Release_.mp3","Cartoon - On _ On (feat. Daniel Levi) _NCS Release_.mp3"));
		trackList.add(new Track("","Culture Code - Make Me Move.jpg","gameImage.png","Culture Code - Make Me Move.mp3","Culture Code - Make Me Move.mp3"));
		trackList.add(new Track("","Imaginate.jpg","gameImage.png","PREVIEW KSHMR, Dzeko & Torres - Imaginate (Original Mix).mp3","PREVIEW KSHMR, Dzeko & Torres - Imaginate (Original Mix).mp3"));
		trackList.add(new Track("","Warriyo - Mortals.jpg","gameImage.png","Warriyo - Mortals.mp3","Warriyo - Mortals.mp3"));
