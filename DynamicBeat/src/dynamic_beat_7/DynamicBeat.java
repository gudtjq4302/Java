...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("On_On Title Image.png","On_On Start Image.png","On_On Start Image.png","Cartoon - On _ On (feat. Daniel Levi) _NCS Release_.mp3","Cartoon - On _ On (feat. Daniel Levi) _NCS Release_.mp3"));
